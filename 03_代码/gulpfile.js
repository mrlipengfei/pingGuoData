...
//pqk 0907 json 文件打包到dist目录
gulp.task('jsontodist', function () {
    var stream = gulp.src('src/Lib/data/**/*.json')
        .pipe(gulp.dest('dist/Lib/data'));
    return stream;
})
// css 打包进入 src 文件夹
...
gulp.task('default', ['csstodist', 'fileinclude', 'serve', 'imagemin', 'Libtodist', 'jstodist','jsontodist', 'watch']);
